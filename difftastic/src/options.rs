...
pub struct DiffOptions {
    ...
    pub strip_cr: bool,
    pub get_addtions: bool,
    pub get_deletions: bool,
    pub get_line_map: bool,
}
...
When multiple overrides are specified, the first matching override wins."))
        ...
        .arg(
            Arg::new("get-addtions").long("get-addtions")
            .help("Get addtion contents")
        )
        .arg(
            Arg::new("get-deletions").long("get-deletions")
            .help("Get deletions contents")
        )
        .arg(
            Arg::new("get_line_map").long("get_line_map")
            .help("get line map")
        )
...
pub fn parse_args() -> Mode {
    ...
    let get_addtions = matches.is_present("get-addtions");

    let get_deletions = matches.is_present("get-deletions");

    let get_line_map = matches.is_present("get_line_map");
